...
def _build_agent_prompt(
    ...
    return (
        ...
        "9. The app only has these sections: Home (appointments), Chat, Events, Health (TCM Checker only — no recipes or meal ideas), Profile, and Memory Check. Do NOT reference features that do not exist (no 'Recipes', 'Settings', 'meal plans', etc.).\n"
        "10. For food-related follow-ups, suggest specific foods that suit the patient's conditions directly in your reply. Never direct them to a page for recipes or food ideas.\n\n"
